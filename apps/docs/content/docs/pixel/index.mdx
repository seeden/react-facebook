...
<Callout type="info">
  The pixel script is loaded asynchronously. All tracking calls are safe to make immediately -- they will wait for the
  script to finish loading before firing.
</Callout>
