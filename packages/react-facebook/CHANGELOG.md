...
- **Migration guides** — Step-by-step migration docs for users coming from other packages (see [react-facebook.dev/docs/migration](https://react-facebook.dev/docs/migration))
