...
See every component in action with interactive controls. Change props, switch languages, and preview results instantly in the [Playground](/playground).
</Callout>

## Explore

<Cards>
  <Card title="Getting Started" description="Installation, provider setup, and your first component." href="/docs/getting-started" />
  <Card title="Components" description="FacebookProvider, Login, Like, Share, Comments, Embeds, Page, and more." href="/docs/components" />
  <Card title="Hooks" description="useLogin, useShare, useGraphAPI, useLocale, usePixel, and other hooks." href="/docs/hooks" />
  <Card title="Facebook Pixel" description="Conversion tracking, page views, custom events, and GDPR consent." href="/docs/pixel" />
  <Card title="Guides" description="Facebook Login setup, Facebook Pixel setup, and version upgrade guides." href="/docs/migration" />
