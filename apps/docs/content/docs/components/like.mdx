...
<Callout type="warn" title="EU/EEA Limitations">
  The Like button plugin is affected by Facebook's privacy changes in European regions. Users in EU/EEA countries and
  the United Kingdom must be logged into Facebook **and** have consented to "App and Website Cookies" in their Facebook
  settings. If these requirements are not met, the Like button will not be visible. This is a Facebook platform
  limitation. Consider alternative engagement methods for European users.
</Callout>
