...
<Callout type="warn" title="EU/EEA Limitations">
  The Comments plugin is affected by Facebook's privacy changes in European regions. Users in EU/EEA countries and the
  United Kingdom must be logged into Facebook **and** have consented to "App and Website Cookies" in their Facebook
  settings. If these requirements are not met, the Comments plugin will not be visible. This is a Facebook platform
  limitation. Consider alternative commenting solutions for European users.
</Callout>
