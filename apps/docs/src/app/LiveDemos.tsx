...
import { FacebookProvider, FacebookErrorBoundary, EmbeddedVideo, EmbeddedPost, Share, Page } from 'react-facebook';
...
function DemoCard({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div className="flex flex-col gap-3">
      <p className="text-xs font-medium uppercase tracking-[0.2em] text-[var(--color-fd-muted-foreground)]">{label}</p>
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <div className="flex flex-col gap-8">
          <DemoCard label="Embedded Post">
            <EmbeddedPost href="https://www.facebook.com/reel/1730774764310324" width={500} showText />
          </DemoCard>
          <DemoCard label="Page Plugin">
            <Page href="https://www.facebook.com/meta" tabs="timeline" width={500} height={300} smallHeader />
          </DemoCard>
        </div>
      </div>
    </FacebookProvider>
